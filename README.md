...
A combination of colour and gradient thresholds were then applied to generate a binary image (the relevant function is called `grad_clr_thresh(, , (, ), (, ))`, found in lines 55 through 72 in `p2_img.py`).  An example of the output generated by this function is shown below.
